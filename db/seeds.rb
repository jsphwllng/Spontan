...
event_5 = Event.new(category: "culture", description: "Come join our group for a tour through Hamburger Bahnhof museum. Bring some time!", location: "Neues Museum, Berlin", date: (DateTime.now + (score.sample).hours), user: user_1, title: "Arty chat and viewing")

...
event_5 = Event.new(category: "culture", description: "Come join our group for a tour through the Pergamon Museum. Bring some time!", location: "Invalidenstraße 50-51, 10557 Berlin", date: (DateTime.now + (score.sample).hours), user: user_1, title: "The World Needs More Modern Art - Looking for Likeminded Connoisseurs")
